...
const tweetMessage = `Just secured my spot on the #SendIt by @ArcanaNetwork waitlist! Excited to discover what this product has to offer. #GetOnWeb3 and join the waitlist at ${generateSenditUrl()}!`;
</script>
