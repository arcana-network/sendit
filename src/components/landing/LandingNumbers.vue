<template>
  <div
    ...
    <div
      class="flex bg-[#212121] bg-opacity-40 gap-[1.5rem] md:gap-[4rem] px-[2.75rem] py-[1rem] md:px-[3.25rem] md:py-[1rem] lg:py-[2rem] lg:px-[3.25rem] max-w-[600px] justify-center w-max rounded-[12px] md:rounded-[30px] -mt-[10px] md:-mt-[25px] border-opacity-50 backdrop-blur-[50px] border-5 border-[#181819]">
      <div class=" flex flex-row items-center gap-10 -ml-5 md:-ml-10">
        ...
        <div class="flex flex-col items-start gap-1">
          ...
          <span class="text-[#c4c4c4] text-[12px] md:text-[12px] lg:text-[20px] 2xl:text-[30px] ">Users Signed Up</span>
        </div>
      </div>
    </div>
    <div
      ...
      <div class="flex flex-row items-center gap-10 -ml-5 md:-ml-10">
        ...
        <div class="flex flex-col items-start gap-1">
          ...
          <span class="text-[#c4c4c4] text-[12px] md:text-[12px] lg:text-[20px] 2xl:text-[30px] text-center">Transactions
            Sent</span>
        </div>
      </div>
    </div>
