  ...
  >
    ...
    >
      <div class="flex flex-row items-center gap-10 -ml-5 md:-ml-10">
        <img
          src="@/assets/images/landing/users.svg"
          alt="Users signed up"
          class="h-[60px] md:h-[100px] 2xl:h-[150px]"
        />
        <div class="flex flex-col items-start gap-1">
          <span
            class="font-bold-onest text-[20px] md:text-[30px] lg:text-[40px] 2xl:text-[60px] leading-[1.5]"
            >500K+</span
          >
          <span
            class="text-[#c4c4c4] text-[12px] md:text-[12px] lg:text-[20px] 2xl:text-[30px]"
    ...
    >
      <div class="flex flex-row items-center gap-10 -ml-5 md:-ml-10">
        <img
          src="@/assets/images/landing/transactions.svg"
          alt="Transactions Sent"
          class="h-[60px] md:h-[100px] 2xl:h-[150px]"
        />
        <div class="flex flex-col items-start gap-1">
          <span
          ...
          >
          <span
            class="text-[#c4c4c4] text-[12px] md:text-[12px] lg:text-[20px] 2xl:text-[30px] text-center"
