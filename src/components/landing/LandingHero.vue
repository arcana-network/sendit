  ...
  <div class="relative -mt-[100px] md:-mt-[100px]">
    ...
    <div class="relative -z-[1] ">
      <img src="@/assets/images/landing/planet1.png"
        class="absolute z-[5] left-20 md:-left-10 top-10 h-[350px] md:h-[350px] bg-blend-darken go-to-linear-animation" />
      <img src="@/assets/images/landing/planet-cloud-right.png"
        class="absolute z-[5] right-[430px] -top-10 md:-top-5 h-[200px] md:h-[200px] bg-blend-darken go-to-linear-animation2" />
