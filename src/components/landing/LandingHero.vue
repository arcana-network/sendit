...
<template>
  <div class="relative -mt-[100px] md:-mt-[100px]">
    ...
    >
      <h1
        class="syne landing-section-title md:mt-10 max-md:max-w-[200px] 2xl:text-[4.75rem] text-center"
      >
        Send Crypto <span class="font-one font-bold-onest">Over Email</span>
      </h1>
      <p
        class="landing-section-subtitle max-w-[800px] text-center max-md:mt-5 md:mt-10 2xl:text-[1.5rem]"
      >
      ...
      >
        ...
        >
          ...
          <img
            class="absolute top-[125%] md:top-[130%] left-0 h-[50px] md:h-[50px]"
            src="@/assets/images/landing/try-it-out-vector-pointer.svg"
          />
          <span
            class="font-caveat text-[1.5rem] md:text-[2.25rem] absolute w-max top-[200%] md:top-[175%] -left-[250%] md:-left-[250%]"
    ...
    <div class="relative -z-[1]">
      <img
        src="@/assets/images/landing/hero-bg-top.webp"
        class="absolute top-0 right-0 z-[6] w-full"
      />
      <img
      ...
      />
      <div
        class="h-[456px] absolute top-0 left-0 right-0 z-[4] bg-gradient-to-b from-black via-black to-transparent"
      ></div>
      <img
        src="@/assets/images/landing/here-sendit-375.webp"
        class="md:hidden relative top-0 left-0 right-0 h-[812px] md:h-[1059px] object-cover object-center w-full z-[2]"
      />
      <img
        src="@/assets/images/landing/hero-sendit-1440.webp"
