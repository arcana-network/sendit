<template>
  <div id="how-does-it-work">
    <div class="flex flex-col md:flex-row md:flex-nowrap md:justify-center md:items-center mt-[10%]">
      <div class="w-full md:w-1/2 flex flex-col gap-1 md:gap-4 lg:gap-6 md:pl-[150px] md:mt-[-5rem] items-center md:items-start">
  ...
  <img class="absolute z-[-1] top-[165%] -left-[30px] md:-left-[150px] h-[300px] md:h-[300px] max-md:hidden go-to-linear-animation"
