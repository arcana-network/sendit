    ...
    <div class="landing-container relative">
      <div class="flex">
        <a href="/" class="flex gap-2 z-1000">
          <img
            alt="SendIt"
            src="@/assets/images/landing/sendit-logomark-30w.webp"
            srcset="
      ...
      <div
        class="absolute z-[1000] right-[1.25rem] top-0 bottom-0 flex items-center gap-4"
      >
        <a
          class="text-[0.95rem] md:text-[0.75rem] 2xl:text-[1rem] leading-[1rem] uppercase font-500 rounded-[25px] md:rounded-[25px] px-6 py-5 md:px-5 md:py-3 cursor-pointer bg-[rgb(54,54,54)]/70 hover:scale-105 transition-colors duration-200 ease-in-out disabled:opacity-50 disabled:cursor-not-allowed"
          href="/app"
        >
          Launch App
        </a>
        <a
          class="w-[200px] h-[50px] p-[5px] max-md:hidden rounded-3xl"
