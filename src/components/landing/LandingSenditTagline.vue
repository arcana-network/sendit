<template>
  <div class="relative pt-20 pb-20">
    <div class="landing-container mt-[4rem] md:mt-[8rem] ">
      <div
        class="md:ml-[4.5rem] p-[1.25rem] md:p-[3.75rem] rounded-[0.625rem] md:rounded-[1.875rem]  bg-[rgb(20,20,20)]/60 z-[1] w-[full] md:w-[1000px] border-4 border-[rgb(26,26,27,0.5)]">
        <div class="flex max-md:flex-col max-md:items-center md:justify-center ">
          <div class="flex items-center">
            ...
            <img src="@/assets/images/landing/apostrophe-open-outline.svg" class="h-2 md:h-4 -mt-2 md:-mt-6" />
            <span class="earn-section-title max-md:text-[1.25rem] md:text-[3.5rem]">&nbsp;Email + Crypto =&nbsp;</span>
