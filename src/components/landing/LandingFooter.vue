<template>
  ...
  >
    ...
    >
      ...
      >
        <div
          class="mb-[1px] md:mb-0 max-md:w-full flex flex-col max-md:items-center"
        >
          <a href="/" class="flex">
            <img
              alt="SendIt"
          ...
          <a
            ...
            target="_blank"
            class="text-white text-[0.9rem]"
            >Made with love by Arcana Network</a
          >
          <a
            class="max-md:hidden w-225 h-50"
        ...
        >
          <ul class="flex flex-col gap-2 mb-[1rem] md:gap-1 text-white">
            ...
            <li class="max-md:hidden">
              <a href="#earn-xp">Earn XP for Using Sendit</a>
            </li>
