<template>
  <div class="relative">
    ...
    <img
      class="absolute z-[-1] bottom-[5%] left-0 md:hidden"
      src="@/assets/images/landing/why-sendit-bg-266w.png"
      loading="lazy"
    />
    <img
      class="absolute z-[-1] top-[65%] left-0 max-md:hidden"
      src="@/assets/images/landing/why-sendit-bg-603w.png"
      loading="lazy"
    />
  </div>
</template>
